        ...
        $node
            ...
            ->prototype('array')
                ->children()
                    ...
                    ->arrayNode("params")
                        ->children()
                            ->scalarNode("endpoint")->isRequired()->defaultValue("tls://gateway.sandbox.push.apple.com:2195")->end()
        ...
        $node
            ...
            ->prototype('array')
                ->children()
                    ...
                    ->arrayNode("params")
                        ->children()
                            ->scalarNode("endpoint")->isRequired()->defaultValue("https://android.googleapis.com/gcm/send")->end()
